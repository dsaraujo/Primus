...
@app_commands.describe(age = "The current age of a character, like 43", modifier = "The modifiers to the aging roll, like a longevity ritual or living conditions, like -2.")
